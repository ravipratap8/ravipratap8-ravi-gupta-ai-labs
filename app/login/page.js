              ...
              <div className="flex items-center justify-between">
                ...
                {mode === 'signin' && (
                  <button
                    ...
                    className="inline-flex items-center gap-1 text-xs font-medium text-cyan-400 transition hover:text-cyan-300 disabled:cursor-not-allowed disabled:opacity-50"
                  >
                    {resetLoading ? (
